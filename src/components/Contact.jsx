                ...
                <div className="w-full lg:w-5/12 flex flex-col justify-start">
                    ...
                    <div className="flex flex-col gap-10">
                        ...
                        <div className="hidden md:block">
                            ...
                            <p className="text-xl tracking-wide">hmtxai@gmail.com</p>
                        </div>

                        {/* Phone */}
                        <div className="hidden md:block">
                            <p className="text-gray-400 text-sm mb-2">Phone:</p>
                            <p className="text-xl tracking-wide">8003062871</p>
                        </div>
                        ...
                        <div className="mt-4 flex flex-col items-center md:items-start">
                            ...
                            <div className="flex items-center justify-center md:justify-start gap-3">
                                <a href="https://www.instagram.com/hmtxai?igsh=OHZuZ3pkeXRheXA=" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                                ...
                                <a href="https://www.linkedin.com/in/hemant-sharma-3135b4290" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                ...
                                <a href="https://github.com/hemant2871" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
