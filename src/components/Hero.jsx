...
const Hero = ({ onPreloadComplete }) => {
  const [text, setText] = useState('hmtXai');
    ...
    >
      ...
      >
        <img
          ...
          className="w-full max-w-[280px] sm:max-w-[340px] md:max-w-[460px] lg:max-w-[520px] xl:max-w-[580px] object-contain drop-shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
        />
      </div>
    </section>
  );
