    ...
    <footer className="relative bg-black text-white py-12 px-6 md:px-16 h-screen flex flex-col justify-between overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full justify-between">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-8 gap-10">
          <div className="flex flex-col gap-6 w-full md:w-auto">
            <div>
              ...
              <a href="mailto:hmtxai@gmail.com" className="text-xl md:text-5xl font-medium hover:text-gray-300 transition-colors break-words">
                hmtxai@gmail.com
              </a>
            </div>
        ...
        <div className="flex flex-wrap justify-between items-center py-6 border-t border-white/10 mb-4 text-sm md:text-lg font-medium">
          <a href="https://www.instagram.com/hmtxai?igsh=OHZuZ3pkeXRheXA=" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">Instagram</a>
          <a href=" https://x.com/hmtxai1" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">Twitter</a>
          <a href="http://www.linkedin.com/in/hemant-sharma-3135b4290" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">LinkedIn</a>
          <a href="https://github.com/hemant2871" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">Github</a>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-xs text-gray-400 mt-auto pt-6">
          <p>© {new Date().getFullYear()} hmtxai. All Rights Reserved.</p>
