...
const aboutWords = [
  { text: "Hey," }, { text: "I'm" },
  { text: "Hemant Sharma.", className: "font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400" },
  { text: "A" }, { text: "passionate" }, { text: "AI-driven" }, { text: "full-stack" }, { text: "developer" }, { text: "who" }, { text: "loves" }, { text: "building" }, { text: "intelligent," }, { text: "scalable" }, { text: "web applications" }, { text: "from" }, { text: "the" }, { text: "ground up." },
  { text: "I" }, { text: "enjoy" }, { text: "turning" }, { text: "ideas" }, { text: "into" }, { text: "real" }, { text: "products" }, { text: "using" }, { text: "tech" }, { text: "stacks" }, { text: "like" },
  ...
  { text: "I'm" }, { text: "always" }, { text: "focused" }, { text: "on" }, { text: "writing" }, { text: "clean," }, { text: "code" }, { text: "and" }, { text: "crafting" }, { text: "seamless" }, { text: "user" }, { text: "experiences" }, { text: "-While" }, { text: "constantly" }, { text: "exploring" }, { text: "emerging" }, { text: "tech" }, { text: "like" },
  { text: "LLMs,", className: "text-white font-medium" },
  { text: "Langchain,", className: "text-white font-medium" },
  { text: "and" },
  { text: "Retrieval-Augmented Generation (RAG) pipelines.", className: "text-white font-medium" }
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 lg:gap-24 items-center">
          ...
          <div className="flex justify-center lg:justify-start pl-0 lg:pl-20">
            <img
              src={aboutImage}
              alt="About"
              className="w-full max-w-[260px] sm:max-w-[300px] md:max-w-[360px] lg:max-w-[420px] xl:max-w-[480px] object-contain drop-shadow-2xl"
            />
          </div>
